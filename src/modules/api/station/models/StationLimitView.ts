...
export class StationLimitView {
  ...
  @ViewColumn({ name: 'flow_rate_inferior_limit' })
  flowRateInferiorLimit: number

  @ViewColumn({ name: 'flow_rate_superior_limit' })
  flowRateSuperiorLimit: number

  @ViewColumn({ name: 'level_inferior_limit' })
  levelInferiorLimit: number

  @ViewColumn({ name: 'level_superior_limit' })
  levelSuperiorLimit: number
}
