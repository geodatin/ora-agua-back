import { ICreateWaterQualityIdeamDTO } from '@modules/observation/dtos/ICreateWaterQualityIdeamDTO'
import { WaterQualityIdeam } from '@modules/observation/models/WaterQualityIdeam'
